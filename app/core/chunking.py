...
class DocumentChunker:
    ...
    def chunk_document(self, text: str, metadata: dict = None) -> List[ProcessedChunk]:
        """
        ...
        for i, chunk_text in enumerate(final_chunks):
            ...
            processed_chunks.append(ProcessedChunk(text=chunk_text, metadata=chunk_meta))
    ...
    def _semantic_split(self, text: str) -> List[str]:
        ...
        for line in lines:
            ...
            if is_header or (current_tokens + line_tokens > self.chunk_size and current_chunk):
    ...
    def _is_boilerplate(self, text: str) -> bool:
        ...
        if len(text) < 50:
             if any(x in text.lower() for x in ['copyright', 'all rights reserved', 'page']):
                 return True
        return False
