...
class Project(Base):
    ...
    browser_tokens = relationship("BrowserToken", back_populates="project", cascade="all, delete-orphan")
...
class ApiKey(Base):
    ...
    scopes: Mapped[List[str]] = mapped_column(ARRAY(String), default=lambda: ["ingest", "query"])
    allowed_origins: Mapped[List[str]] = mapped_column(ARRAY(String), default=list)
